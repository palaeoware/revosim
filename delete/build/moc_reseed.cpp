...
namespace {
struct qt_meta_tag_ZN6ReseedE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN6ReseedE = QtMocHelpers::stringData(
    "Reseed",
...
Q_CONSTINIT static const uint qt_meta_data_ZN6ReseedE[] = {
...
Q_CONSTINIT const QMetaObject Reseed::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6ReseedE.offsetsAndSizes,
    qt_meta_data_ZN6ReseedE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6ReseedE_t,
        // Q_OBJECT / Q_GADGET
...
void *Reseed::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6ReseedE.stringdata0))
