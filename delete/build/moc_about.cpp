...
static constexpr auto qt_meta_stringdata_ZN5AboutE = QtMocHelpers::stringData(
    "About"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN5AboutE[] = {
...
Q_CONSTINIT const QMetaObject About::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN5AboutE.offsetsAndSizes,
    qt_meta_data_ZN5AboutE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN5AboutE_t,
        // Q_OBJECT / Q_GADGET
...
void *About::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN5AboutE.stringdata0))
