...
.. figure:: _static/populationSceneDefault.png
    ...
    Default Environmental Scene showing three blocks of colour in vertical strips.
...
.. raw:: html
	...
	<p class="caption">Run showing environmental scene with four environmental images on a loop (created with v2.0.0).</p>
