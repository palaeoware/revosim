...
DefaultDirName={pf}\Palaeoware\REvoSim\v3.0.0
DefaultGroupName=Palaeoware\REvoSim
ArchitecturesAllowed=x64
ArchitecturesInstallIn64BitMode=x64
LicenseFile=LICENSE.md
OutputDir=.\build
OutputBaseFilename=REvoSimInstaller_v3.0.0_win_x64
Compression=lzma
SolidCompression=yes
ChangesAssociations=yes
AppCopyright=Copyright (C) 2008-2019 by Mark D. Sutton, Russell J. Garwood, Euan Furness, and Alan R.T. Spencer
...
[Icons]
Name: "{group}\REvoSim (v3.0.0)"; Filename: "{app}\revosim.exe";
Name: "{group}\EnviroGen (v3.0.0)"; Filename: "{app}\envirogen.exe";
Name: "{group}\Uninstall (v3.0.0)"; Filename: "{uninstallexe}"
