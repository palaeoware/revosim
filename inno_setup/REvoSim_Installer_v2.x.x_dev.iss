...
DefaultDirName={pf}\Palaeoware\REvoSim\v2.x.x_dev
DefaultGroupName=Palaeoware\REvoSim
ArchitecturesAllowed=x64
ArchitecturesInstallIn64BitMode=x64
LicenseFile=.\bin\LICENSE.md
OutputDir=.\build
OutputBaseFilename=REvoSimInstaller_v2.x.x_dev_win_x64
Compression=lzma
...
[Icons]
Name: "{group}\REvoSim (v2.x.x Dev)"; Filename: "{app}\revosim.exe";
Name: "{group}\EnviroGen (v2.x.x Dev)"; Filename: "{app}\envirogen.exe";
Name: "{group}\Uninstall (v2.x.x Dev)"; Filename: "{uninstallexe}"
